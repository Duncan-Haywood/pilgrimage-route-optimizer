defmodule PilgrimageRouteOptimizerWeb.CoreComponents do
  @moduledoc """
  Provides core UI components.

  At first glance, this module may seem daunting, but its goal is to provide
  core building blocks for your application. The components here are used
  throughout the application, and they are designed to be customizable and
  extensible.
  ...
  attr :id, :string, default: "flash-group", doc: "the id of the flash group"
  ...
  """
  attr :id, :string, doc: "the id of the flash container"
  attr :flash, :map, required: true, doc: "the map of flash messages"
